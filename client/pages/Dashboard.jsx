          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link to="/" className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-dark-blue rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <Card key="user-info-card" className="solid-dark-card shadow-xl">
              <CardHeader className="text-center pb-6">
                <div className="relative mx-auto mb-4">
                  <div className="w-24 h-24 bg-gradient-dark-blue rounded-full flex items-center justify-center mx-auto shadow-2xl">
            ...
            <Card key="quick-actions-card" className="solid-dark-card shadow-xl">
              ...
              <CardContent className="space-y-3">
                <Link key="new-resume" to="/builder">
                  <Button className="w-full justify-start bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg hover:shadow-xl transition-all duration-200">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div key="header-section" className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link to="/builder">
                <Button size="lg" className="bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg hover:shadow-xl transition-all duration-200">
            ...
            {filteredResumes.length === 0 && searchQuery && (
              <div key="empty-state-section">
                <Card className="solid-dark-card shadow-xl">
                  ...
                  <Link to="/builder">
                    <Button className="bg-gradient-dark-blue text-white hover:opacity-90">
                      <Plus className="w-4 h-4 mr-2" />
                      Create New Resume
                    </Button>
                  </Link>
