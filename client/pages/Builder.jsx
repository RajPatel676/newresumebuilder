...
export default function Builder() {
    ...
    <div className="space-y-6 md:space-y-8">
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="fullName" className="text-sm font-semibold text-foreground flex items-center gap-2 terminal-text">
          ...
          <Input
            ...
            placeholder="$ echo 'John Doe'"
            className="minimal-input h-10 md:h-12"
            required
          />
        </div>
        <div className="space-y-2">
          <Label htmlFor="email" className="text-sm font-semibold text-foreground flex items-center gap-2 terminal-text">
          ...
          <Input
            ...
            placeholder="$ mail john@example.com"
            className="minimal-input h-10 md:h-12"
            required
          />
        </div>
      ...
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="phone" className="text-sm font-semibold text-foreground terminal-text">
            Phone
          </Label>
          <Input
            id="phone"
            ...
            placeholder="$ tel +1 (555) 123-4567"
            className="minimal-input h-10 md:h-12"
          />
        </div>
        <div className="space-y-2">
          <Label htmlFor="address" className="text-sm font-semibold text-foreground terminal-text">
            Address
          </Label>
          <Input
            id="address"
      ...
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="linkedin" className="text-sm font-semibold text-foreground terminal-text">
            LinkedIn
          </Label>
          <Input
            id="linkedin"
            ...
            placeholder="$ curl linkedin.com/in/johndoe"
            className="minimal-input h-10 md:h-12"
          />
        </div>
        <div className="space-y-2">
          <Label htmlFor="website" className="text-sm font-semibold text-foreground terminal-text">
            Website/Portfolio
          </Label>
          <Input
            id="website"
  ...
  const renderSummarySection = () => (
    <div className="space-y-6">
      <div className="space-y-2">
        <Label htmlFor="summary" className="text-sm font-semibold text-foreground flex items-center gap-2 terminal-text">
          <MessageSquare className="w-4 h-4 text-primary" />
        ...
        <div className="terminal-window">
          <div className="terminal-header">
            ...
            <span className="text-xs text-muted-foreground ml-4">~/summary.txt</span>
          </div>
          <Textarea
            id="summary"
            value={summary}
            ...
            className="min-h-[120px] bg-background border-0 text-foreground focus:border-0 focus:ring-0 terminal-text rounded-none resize-none"
            rows={6}
          />
        </div>
        <p className="text-sm text-muted-foreground terminal-text">
          <span className="text-primary">#</span> Tip: Keep it concise (2-3 sentences) and focus on what makes you unique
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-dark relative overflow-hidden">
      ...
      <header className="bg-background/95 backdrop-blur-lg border-b border-primary/30 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 py-3 md:py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3 md:space-x-4">
            <div className="w-10 md:w-12 h-10 md:h-12 bg-accent border border-primary rounded flex items-center justify-center shadow-terminal">
              <FileText className="w-6 md:w-7 h-6 md:h-7 text-primary" />
            </div>
            <div>
              <h1 className="text-lg md:text-2xl font-bold text-primary font-mono glow-text">
                &gt; CareerCraft_
              </h1>
              <div className="flex items-center gap-2">
                <Sparkles className="w-3 md:w-4 h-3 md:h-4 text-primary" />
                <p className="text-xs md:text-sm text-primary font-medium terminal-text">AI_POWERED</p>
              </div>
            </div>
          </div>
          <div className="flex items-center space-x-2 md:space-x-4">
            <Button
              ...
              className="bg-transparent border-primary text-foreground hover:bg-primary hover:text-primary-foreground px-2 md:px-4"
            >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
        <div className={`grid gap-4 md:gap-6 lg:gap-8 ${sidePreview ? 'lg:grid-cols-6' : 'md:grid-cols-4'}`}>
          {/* Enhanced Sidebar */}
          <div className={`${sidePreview ? 'lg:col-span-1' : 'md:col-span-1'} space-y-4 md:space-y-6`}>
            {/* Navigation */}
            <Card className="minimal-card shadow-minimal-lg">
                    ...
                    <Button
                      ...
                      className={`w-full justify-start transition-all duration-200 ${
                        activeSection === section.id
                          ? 'bg-gradient-dark-blue text-white shadow-lg hover:shadow-xl'
            ...
            <Card className="minimal-card shadow-minimal-lg">
              ...
              <CardContent className="space-y-3 p-4 md:p-6 pt-0">
                <Button
                  ...
                  variant="outline"
                  className="w-full bg-transparent border-primary text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary"
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full mb-2 bg-transparent border-primary text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary"
                >
                ...
                <Button
                  ...
                  className="w-full bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg hover:shadow-xl transition-all duration-200"
                >
                  {isGeneratingPDF ? (
                    <>
          ...
          <div className={`${sidePreview ? 'lg:col-span-3' : 'md:col-span-3'} order-2 md:order-none`}>
            <Card className="minimal-card shadow-minimal-lg">
              <CardHeader className="p-4 md:p-6 pb-4 md:pb-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <Badge className="bg-primary/20 text-primary border-primary/40 self-start sm:self-center">
          ...
          {sidePreview && (
            <div className="lg:col-span-2 hidden lg:block order-3">
              <Card className="minimal-card shadow-minimal-lg sticky top-24 max-h-[calc(100vh-8rem)] overflow-hidden">
                <CardHeader className="p-4 pb-4 border-b border-border">
                ...
                <CardContent className="p-2 md:p-4 overflow-auto max-h-[calc(100vh-12rem)]">
        ...
        {showPreview && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-2 md:p-4">
            <div className="bg-background rounded-lg md:rounded-2xl shadow-3xl w-full max-w-4xl max-h-[95vh] md:max-h-[90vh] overflow-auto border border-border">
              <div className="p-4 md:p-6 border-b border-border flex items-center justify-between">
                <h3 className="text-lg md:text-xl font-bold text-foreground">Resume Preview</h3>
                <Button
                  variant="outline"
