    ...
    <div className="min-h-screen bg-gradient-dark">
      ...
      <header className="bg-black/90 backdrop-blur-lg border-b border-gray-700/60 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link to="/builder">
            <Button className="bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg">
              Start Building
            </Button>
          </Link>
        </div>
      ...
      <div className="container mx-auto px-6 py-12">
            ...
            return (
              <div key={template.id} className="space-y-8">
                <div className="text-center">
                  <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-dark-blue text-white font-semibold mb-6 shadow-lg">
                    {template.name}
                  </div>
                ...
                <div className="solid-dark-card rounded-2xl shadow-2xl overflow-hidden border border-gray-700/50">
                  <div className="p-4 bg-black/50 border-b border-gray-700/50 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Link to="/builder">
                        <Button size="sm" className="bg-gradient-dark-blue text-white hover:opacity-90">
                          Use This Template
                        </Button>
                      </Link>
                    </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-12 text-white border border-primary/30 shadow-2xl">
            ...
            <Link to="/builder">
              <Button size="lg" className="text-lg px-10 py-6 bg-gradient-dark-blue text-white hover:opacity-90 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                Start Building Now
              </Button>
            </Link>
          </div>
