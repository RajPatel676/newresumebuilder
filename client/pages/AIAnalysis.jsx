        ...
        <Card className="w-full max-w-md solid-dark-card shadow-2xl">
          ...
          <CardContent className="space-y-4">
            <Button 
              ...
              className="w-full bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg"
            >
              Go to Login
            </Button>
            <Button 
      ...
      <header className="bg-black/90 backdrop-blur-lg border-b border-gray-700/60 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div
            ...
            title="Back to Home"
          >
            <div className="w-12 h-12 bg-gradient-dark-blue rounded-xl flex items-center justify-center shadow-xl">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3 bg-black/50 rounded-full px-4 py-2 border border-gray-600">
              <div className="w-8 h-8 bg-gradient-dark-blue rounded-full flex items-center justify-center">
                <span className="text-xs font-bold text-white">{user.firstName[0]}</span>
              </div>
              ...
              <CardContent className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  {file && (
                    <div className="flex items-center gap-4 text-gray-300 bg-primary/10 p-6 rounded-xl border border-primary/30 shadow-lg">
                      <div className="w-12 h-12 bg-gradient-dark-blue rounded-lg flex items-center justify-center">
                  ...
                  <Button
                    ...
                    className="w-full h-16 bg-gradient-dark-blue text-white hover:opacity-90 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                  >
                    {isAnalyzing ? (
                      <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-primary/30 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                    <div className="w-16 h-16 bg-gradient-dark-blue rounded-2xl flex items-center justify-center mb-6 shadow-lg">
          ...
          <div className="space-y-8 max-w-7xl mx-auto">
            ...
            <div className="flex justify-center gap-6">
              ...
              <Button 
                ...
                className="px-8 py-4 text-lg bg-gradient-dark-blue text-white hover:opacity-90 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
              >
